...
namespace exercicio1
{
    class Program
    {
        ...
        static int[] arraynumeros = new int[3]; //aqui é a variável onde vou guardar o input do user (após conversão)
        static string[] userInput = new string[3]; //aqui é a variavel array onde vai buscar o input do user
        ...
        static void Avg() {
            Console.WriteLine("\n Média \n");
            double avg = Queryable.Average(arraynumeros.AsQueryable());
        ...
        static void Median() {
            Console.WriteLine("\n Mediana \n");
            int numberCount = arraynumeros.Count();
            int halfIndex = arraynumeros.Count() / 2;
            var sortedNumbers = arraynumeros.OrderBy(n => n);
            double median;
            if((numberCount % 2) == 0) {
                median = ((sortedNumbers.ElementAt(halfIndex - 1)) / 2);
            } else {
                median = sortedNumbers.ElementAt(halfIndex);
            }
            Console.WriteLine(("A mediana é = ") + median);
            Options();
        }
        ...
        static void Max() {
            Console.WriteLine("\n Máximo \n");
            double avg = Queryable.Max(arraynumeros.AsQueryable());
            Console.WriteLine("Máximo = " + avg);
            Options();
        }
        ...
        static void Min() {
            Console.WriteLine("\n Mínimo \n");
            double avg = Queryable.Min(arraynumeros.AsQueryable());
            Console.WriteLine("Mínimo = " + avg);
            Options();
        }
